...
#ifndef PLAYER_DOWNLOADS_SWIFT_H
#define PLAYER_DOWNLOADS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="player_downloads",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16player_downloads21PlayerDownloadsPlugin")
@interface PlayerDownloadsPlugin : NSObject <FlutterPlugin>
