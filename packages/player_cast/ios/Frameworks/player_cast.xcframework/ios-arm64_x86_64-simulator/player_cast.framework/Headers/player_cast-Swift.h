...
#ifndef PLAYER_CAST_SWIFT_H
#define PLAYER_CAST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="player_cast",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11player_cast16PlayerCastPlugin")
@interface PlayerCastPlugin : NSObject <FlutterPlugin>
